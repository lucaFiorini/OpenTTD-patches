...
public:
	static inline const SaveLoad description[] = {
		...
		SLE_CONDSTR(Vehicle, name, VarTypes::STR | StringValidationSetting::AllowControlCode, 0, SaveLoadVersion::ReplaceCustomNameArray, SaveLoadVersion::MaxVersion),
		...
		SLE_CONDVAR(Vehicle, current_order_time, VarTypes::U32, SaveLoadVersion::Timetables, SaveLoadVersion::TimetableTicksType),
		...
		SLEG_CONDVAR("depot_unbunching_last_departure", _unbunch_state.depot_unbunching_last_departure, VarTypes::U64, SaveLoadVersion::DepotUnbunching, SaveLoadVersion::MaxVersion),
		SLEG_CONDVAR("depot_unbunching_next_departure", _unbunch_state.depot_unbunching_next_departure, VarTypes::U64, SaveLoadVersion::DepotUnbunching, SaveLoadVersion::MaxVersion),
		SLEG_CONDVAR("round_trip_time",                 _unbunch_state.round_trip_time,                 VarTypes::I32,  SaveLoadVersion::DepotUnbunching, SaveLoadVersion::MaxVersion),
	};
...
public:
	static inline const SaveLoad description[] = {
		...
		SLEG_CONDVECTOR("path.td", _path_td, VarTypes::U8, SaveLoadVersion::RoadvehPathCache, SaveLoadVersion::PathCacheFormat),
		SLEG_CONDVECTOR("path.tile", _path_tile, VarTypes::U32, SaveLoadVersion::RoadvehPathCache, SaveLoadVersion::PathCacheFormat),
