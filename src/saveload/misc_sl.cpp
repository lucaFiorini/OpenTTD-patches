...
static const SaveLoad _date_desc[] = {
	...
	SLEG_CONDVAR("date",                   CalTime::Detail::now.cal_date,          SLE_INT32,                           SaveLoadVersion::BigDates, SaveLoadVersion::MaxVersion),
	...
	SLEG_CONDVAR("tick_counter",           _tick_counter,                          SLE_UINT64,                          SaveLoadVersion::U64TickCounter, SaveLoadVersion::MaxVersion),
	SLEG_CONDVAR("economy_date",           EconTime::Detail::now.econ_date,        SLE_INT32,                           SaveLoadVersion::EconomyDate, SaveLoadVersion::MaxVersion),
	SLEG_CONDVAR("economy_date_fract",     EconTime::Detail::now.econ_date_fract,  SLE_UINT16,                          SaveLoadVersion::EconomyDate, SaveLoadVersion::MaxVersion),
	SLEG_CONDVAR("calendar_sub_date_fract", CalTime::Detail::now.sub_date_fract,   SLE_UINT16,                          SaveLoadVersion::CalendarSubDateFract, SaveLoadVersion::MaxVersion),
