...
static const SaveLoad _date_desc[] = {
	SLEG_CONDVAR("date",                   CalTime::Detail::now.cal_date,          VarFileType::U16 | VarMemType::I32,     SaveLoadVersion::MinVersion,  SaveLoadVersion::BigDates),
	SLEG_CONDVAR("date",                   CalTime::Detail::now.cal_date,          VarTypes::I32,                          SaveLoadVersion::BigDates, SaveLoadVersion::MaxVersion),
	    SLEG_VAR("date_fract",             CalTime::Detail::now.cal_date_fract,    VarTypes::U16),
	SLEG_CONDVAR("tick_counter",           _tick_counter,                          VarFileType::U16 | VarMemType::U64,     SaveLoadVersion::MinVersion, SaveLoadVersion::U64TickCounter),
	SLEG_CONDVAR("tick_counter",           _tick_counter,                          VarTypes::U64,                          SaveLoadVersion::U64TickCounter, SaveLoadVersion::MaxVersion),
	SLEG_CONDVAR("economy_date",           EconTime::Detail::now.econ_date,        VarTypes::I32,                          SaveLoadVersion::EconomyDate, SaveLoadVersion::MaxVersion),
	SLEG_CONDVAR("economy_date_fract",     EconTime::Detail::now.econ_date_fract,  VarTypes::U16,                          SaveLoadVersion::EconomyDate, SaveLoadVersion::MaxVersion),
	SLEG_CONDVAR("calendar_sub_date_fract", CalTime::Detail::now.sub_date_fract,   VarTypes::U16,                          SaveLoadVersion::CalendarSubDateFract, SaveLoadVersion::MaxVersion),
